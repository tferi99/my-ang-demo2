...
exports.logout = exports.login = exports.findLessonsForCourse = exports.findCourseById = exports.SIMPLE_INPUT_VALUE = exports.GRIDSTER = exports.LESSONS = exports.COURSES = exports.USERS = void 0;
exports.USERS = [
    {
        id: 1,
        email: 'a@b.c',
...
exports.COURSES = {
    ...
    2: {
        ...
        longDescription: 'Learn Web Security Fundamentals and apply them to defend an Angular / Node Application from multiSubs types of attacks.',
...
function findLessonsForCourse(courseId) {
    return Object.values(exports.LESSONS).filter(lesson => lesson.courseId == courseId);
}
exports.findLessonsForCourse = findLessonsForCourse;
function login(email, password) {
    const user = Object.values(exports.USERS).find(u => u.email === email);
